...
> A full-stack attendance management system developed using ASP.NET, C#, and SQL Server to streamline student attendance tracking and reporting.
...
**Tech Stack:** ASP.NET MVC • C# • SQL Server • ADO.NET • Entity Framework • Bootstrap • JavaScript
